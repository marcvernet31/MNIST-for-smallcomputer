...
#define AI_NETWORK_MODEL_SIGNATURE     "839507964ac563d01a3b1ea7390ed78b"
...
#define AI_TOOLS_DATE_TIME   "Mon Dec  6 11:32:03 2021"
...
AI_STATIC ai_array dense_9_bias_array;   /* Array #0 */
AI_STATIC ai_array dense_9_weights_array;   /* Array #1 */
...
AI_STATIC ai_array serving_default_flatten_2_input0_output_array;   /* Array #10 */
...
AI_STATIC ai_tensor dense_9_bias;   /* Tensor #0 */
AI_STATIC ai_tensor dense_9_weights;   /* Tensor #1 */
...
AI_STATIC ai_tensor serving_default_flatten_2_input0_output;   /* Tensor #10 */
AI_STATIC ai_tensor serving_default_flatten_2_input0_output0;   /* Tensor #11 */
...
AI_STATIC ai_tensor dense_9_output;   /* Tensor #20 */


/**  Forward network tensor chain declarations  *******************************/
AI_STATIC_CONST ai_tensor_chain dense_1_chain;   /* Chain #0 */
AI_STATIC_CONST ai_tensor_chain nl_2_chain;   /* Chain #1 */
...
AI_STATIC_CONST ai_tensor_chain nl_8_chain;   /* Chain #7 */
AI_STATIC_CONST ai_tensor_chain dense_9_chain;   /* Chain #8 */


/**  Forward network layer declarations  **************************************/
AI_STATIC ai_layer_dense dense_1_layer; /* Layer #0 */
AI_STATIC ai_layer_nl nl_2_layer; /* Layer #1 */
...
AI_STATIC ai_layer_nl nl_8_layer; /* Layer #7 */
AI_STATIC ai_layer_dense dense_9_layer; /* Layer #8 */
...
/* Array#10 */
AI_ARRAY_OBJ_DECLARE(
  serving_default_flatten_2_input0_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
...
/* Array#19 */
AI_ARRAY_OBJ_DECLARE(
  dense_9_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
  NULL, NULL, 10, AI_STATIC)
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 40, 20, 1, 1), AI_STRIDE_INIT(4, 4, 160, 3200, 3200),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 60, 40, 1, 1), AI_STRIDE_INIT(4, 4, 240, 9600, 9600),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 80, 60, 1, 1), AI_STRIDE_INIT(4, 4, 320, 19200, 19200),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 784, 80, 1, 1), AI_STRIDE_INIT(4, 4, 3136, 250880, 250880),
  1, &dense_1_weights_array, NULL)

/* Tensor #10 */
AI_TENSOR_OBJ_DECLARE(
  serving_default_flatten_2_input0_output, AI_STATIC,
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 28, 28, 1), AI_STRIDE_INIT(4, 4, 4, 112, 3136),
  1, &serving_default_flatten_2_input0_output_array, NULL)

/* Tensor #11 */
AI_TENSOR_OBJ_DECLARE(
  serving_default_flatten_2_input0_output0, AI_STATIC,
  0x0, 0x0,
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &serving_default_flatten_2_input0_output0),
...
AI_STATIC_CONST ai_float nl_2_nl_params_data[] = { 1.0 };
AI_ARRAY_OBJ_DECLARE(
    nl_2_nl_params, AI_ARRAY_FORMAT_FLOAT,
    nl_2_nl_params_data, nl_2_nl_params_data, 1, AI_STATIC_CONST)
AI_TENSOR_CHAIN_OBJ_DECLARE(
...
AI_STATIC_CONST ai_float nl_4_nl_params_data[] = { 1.0 };
AI_ARRAY_OBJ_DECLARE(
    nl_4_nl_params, AI_ARRAY_FORMAT_FLOAT,
    nl_4_nl_params_data, nl_4_nl_params_data, 1, AI_STATIC_CONST)
AI_TENSOR_CHAIN_OBJ_DECLARE(
...
AI_STATIC_CONST ai_float nl_6_nl_params_data[] = { 1.0 };
AI_ARRAY_OBJ_DECLARE(
    nl_6_nl_params, AI_ARRAY_FORMAT_FLOAT,
    nl_6_nl_params_data, nl_6_nl_params_data, 1, AI_STATIC_CONST)
AI_TENSOR_CHAIN_OBJ_DECLARE(
...
AI_STATIC_CONST ai_float nl_8_nl_params_data[] = { 1.0 };
AI_ARRAY_OBJ_DECLARE(
    nl_8_nl_params, AI_ARRAY_FORMAT_FLOAT,
    nl_8_nl_params_data, nl_8_nl_params_data, 1, AI_STATIC_CONST)
AI_TENSOR_CHAIN_OBJ_DECLARE(
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 560, 1,
                     NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_IN_NUM, &serving_default_flatten_2_input0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_OUT_NUM, &dense_9_output),
  ...
  ai_network* net_ctx, const ai_buffer* activation_buffer)
{
...

  {
    ...
    serving_default_flatten_2_input0_output_array.data = AI_PTR(NULL);
    serving_default_flatten_2_input0_output_array.data_start = AI_PTR(NULL);
    ...
    dense_3_output_array.data = AI_PTR(activations + 320);
    dense_3_output_array.data_start = AI_PTR(activations + 320);
    nl_4_output_array.data = AI_PTR(activations + 0);
    nl_4_output_array.data_start = AI_PTR(activations + 0);
    dense_5_output_array.data = AI_PTR(activations + 240);
    dense_5_output_array.data_start = AI_PTR(activations + 240);
    nl_6_output_array.data = AI_PTR(activations + 0);
    nl_6_output_array.data_start = AI_PTR(activations + 0);
    dense_7_output_array.data = AI_PTR(activations + 160);
    dense_7_output_array.data_start = AI_PTR(activations + 160);
    nl_8_output_array.data = AI_PTR(activations + 0);
    nl_8_output_array.data_start = AI_PTR(activations + 0);
    dense_9_output_array.data = AI_PTR(NULL);
    dense_9_output_array.data_start = AI_PTR(NULL);
  ...
  ai_network* net_ctx, const ai_buffer* weights_buffer)
{
...

  {
    ...
    dense_9_bias_array.data = AI_PTR(weights + 284480);
    dense_9_bias_array.data_start = AI_PTR(weights + 284480);
    dense_9_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_9_weights_array.data = AI_PTR(weights + 283680);
    dense_9_weights_array.data_start = AI_PTR(weights + 283680);
    dense_7_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_7_bias_array.data = AI_PTR(weights + 283600);
    dense_7_bias_array.data_start = AI_PTR(weights + 283600);
    dense_7_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_7_weights_array.data = AI_PTR(weights + 280400);
    dense_7_weights_array.data_start = AI_PTR(weights + 280400);
    dense_5_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_5_bias_array.data = AI_PTR(weights + 280240);
    dense_5_bias_array.data_start = AI_PTR(weights + 280240);
    dense_5_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_5_weights_array.data = AI_PTR(weights + 270640);
    dense_5_weights_array.data_start = AI_PTR(weights + 270640);
    dense_3_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_3_bias_array.data = AI_PTR(weights + 270400);
    dense_3_bias_array.data_start = AI_PTR(weights + 270400);
    dense_3_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_3_weights_array.data = AI_PTR(weights + 251200);
    dense_3_weights_array.data_start = AI_PTR(weights + 251200);
    dense_1_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_bias_array.data = AI_PTR(weights + 250880);
    dense_1_bias_array.data_start = AI_PTR(weights + 250880);
